...
if __name__ == "__main__":
    ...
    show_description("1 : Check Baxter Boot",
                     "    Please type below",
                     "    rosrun jsk_2014_picking_challenge check_after_boot.py")
    ask_yesno()
    ...
    show_description("3 : Check Baxter.launch",
                     "    Please type below",
                     "    rosrun jsk_2014_picking_challenge check_after_baxter.py")
    ask_yesno()
    ...
    show_description("5 : Check setup.launch",
                     "    Please type below",
                     "    rosrun jsk_2014_picking_challenge check_after_setup.py")
    ask_yesno()

    show_description("7 : Install apc.json",
                     "    Please copy",
                     "    cp apc.json `rospack find jsk_2014_picking_challenge`/data/apc.json")
    ask_yesno()

    show_description("8 : Check apc.json",
                     "    Please type below",
                     "    rosrun jsk_2014_picking_challenge check_json.py")
    ask_yesno()
