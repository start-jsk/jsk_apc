...
import rospkg
from jsk_apc2016_common.bin import BinPython
...
class Pipeline(object):
    ...
    def from_bin_array(self, bin_arr_msg):
        self.target_bin_name
        for bin_msg in bin_arr_msg.array:
            self.shelf[bin_msg.name] = BinPython(bin_msg=bin_msg)
