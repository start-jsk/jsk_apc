...
"""
this script will extract color_histogram from masked_data($(jsk_2016_01_baxter_apc)/data/berkeley_dataset_mask_applied) and save it.
This program performs classification by SVM.

Usage : 
prepare berkeley_dataset_mask_applied on $(jsk_2016_01_baxter_apc)/data/berkeley_dataset_mask_applied
python color_histogram_features.py
"""
...
class ColorHistogramFeatures(object):
    ...
    def load_data(self):
        ...
        print("loading data ... ")
        data_dir = get_data_dir()
        feature_path = os.path.join(data_dir, 'histogram_data/hsi.pkl.gz')
    ...
    def images(self, dir_name='berkeley_dataset_mask_applied'):
