...
class ARC2017ItemDataSyntheticInstanceSegmentationDataset(
    ...
    def get_example(self, i):
        ...
        imgs, lbls = grasp_fusion_lib.datasets.apc.arc2017.jsk.get_shelf_data()
        ...
        if self._do_aug and self._aug_level in ['all', 'image']:
            ...
            shelf_datum = next(grasp_fusion_lib.aug.augment_object_data(
        ...
        if self._do_aug and self._aug_level in ['all', 'image']:
            ...
            stacked['bboxes'] = grasp_fusion_lib.image.masks_to_bboxes(
                stacked['masks'])
