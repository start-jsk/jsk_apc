...
import grasp_fusion_lib.aug
import grasp_fusion_lib.data
from grasp_fusion_lib.datasets.apc.arc2017.base import class_names_arc2017
from grasp_fusion_lib.datasets.apc.arc2017.base import DATASETS_DIR
from grasp_fusion_lib.datasets.apc.arc2017.base import \
    get_class_id_map_from_2016_to_2017
from grasp_fusion_lib.datasets.apc.arc2017.item_data import load_item_data
...
class CollectedOnKivaPod(chainer.dataset.DatasetMixin):
    ...
    def _convert_dataset_16_to_17(self):
        ...
        dataset_apc2016 = grasp_fusion_lib.datasets.apc.JskAPC2016Dataset(
            split='all')
        for index in range(len(dataset_apc2016)):
            ...
            lbl_viz = lbl.copy()
            lbl_viz[lbl == -1] = 0
            lbl_viz = grasp_fusion_lib.image.label2rgb(
    ...
    def get_example(self, i):
        ...
        if self.aug_method == 'stack':
            ...
            obj_datum = grasp_fusion_lib.aug.stack_objects(
                img, lbl, object_data, region_label=41,
                random_state=random_state)
            obj_datum = next(grasp_fusion_lib.aug.augment_object_data(
...
class ItemDataDataset(chainer.dataset.DatasetMixin):
    ...
    def get_example(self, i):
        ...
        y1, x1, y2, x2 = grasp_fusion_lib.image.masks_to_bboxes(
            [mask_labeled]
        )[0]
        ...
        if self._do_aug and self._aug_level in ['all', 'object']:
            item_data = grasp_fusion_lib.aug.augment_object_data(
