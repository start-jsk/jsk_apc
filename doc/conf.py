...
package_xml = os.path.join(this_dir, '../jsk_apc/package.xml')
...
man_pages = [
    (master_doc, 'jsk_apc', u'jsk_apc Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'jsk_apc', u'jsk_apc Documentation',
   author, 'jsk_apc', 'One line description of project.',
   'Miscellaneous'),
]
