...
def install_test_data(filename, url, md5, compressed_bag=None):
    ...
    data_dir = os.path.join(rp.get_path('jsk_2015_05_baxter_apc'), 'test_data')
    ...
    if os.path.exists(output) and check_md5sum(output, md5):
        print("[jsk_2015_05_baxter_apc] '{}' is already latest version".format(output))
        return
    print("[jsk_2015_05_baxter_apc] Installing '{}'".format(output))
    ...
    print("[jsk_2015_05_baxter_apc] Done installing '{}'".format(output))


def main():
    print('[jsk_2015_05_baxter_apc] Start installing test data')
    ...
    print('[jsk_2015_05_baxter_apc] Done installing test data')
