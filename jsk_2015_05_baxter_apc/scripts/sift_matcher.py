...
jsk_2014_baxter_apc/scripts/extract_sift_from_objdata.py.

Usage
-----

    $ roslaunch jsk_2014_baxter_apc sift_matcher_usbcamera.launch
    $ rosrun jsk_2014_baxter_apc sift_matcher.py
...
from jsk_2014_baxter_apc.cfg import SIFTMatcherConfig
